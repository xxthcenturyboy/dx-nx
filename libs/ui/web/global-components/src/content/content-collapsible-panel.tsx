...
export const CollapsiblePanel: React.FC<CollapsiblePanelPropsType> =
  React.forwardRef((props, ref) => {
    const { children, headerTitle, initialOpen, isLoading, panelId } = props;
    const [expanded, setExpanded] = useState<string | false>(
      initialOpen ? panelId : false
    );
