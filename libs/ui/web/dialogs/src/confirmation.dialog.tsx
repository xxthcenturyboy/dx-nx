...
export const ConfirmationDialog: React.FC<ConfirmationDialogProps> = ({
  ...
  const [showLottieInitial, setShowLottieInitial] =
    React.useState<boolean>(true);
  const [showLottieCancel, setShowLottieCancel] =
    React.useState<boolean>(false);
  const [showLottieSuccess, setShowLottieSuccess] =
    React.useState<boolean>(false);
  ...
  return (
    <DialogWrapper>
      ...
      <CustomDialogContent>
        {showLottieInitial && !(showLottieCancel || showLottieSuccess) && (
          <QuestionMarkLottie />
        )}
